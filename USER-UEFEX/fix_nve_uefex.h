...
E: Only normal stresses can be controlled with fix nve/uefex
...
E: All controlled stresses must have the same value in fix nve/uefex

Stress control is only possible when the stress specified for each dimension is the same

E: Dimensions with controlled stresses must have same strain rate in fix nve/uefex
